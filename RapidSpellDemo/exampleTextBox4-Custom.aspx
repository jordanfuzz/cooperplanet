            ...
            <td bgcolor="#C1CDE5" align="center">
               <table border="0" cellpadding="0" cellspacing="0" width="80%">
                        ...
                        <table border="0" cellpadding="0" cellspacing="8">
                           ...
                           <tr>
                              <td width="500" valign="top" align="left" bgcolor="#C1CDE5">
                                 ...
                                 <p>This is an evaluation version, containing a dictionary without any words beginning with 'z'.
				 ...
				 <RapidSpellWeb:RapidSpellWebLauncher id="rapidSpellWebLauncher" runat="server" 
						TextComponentName="myForm.sourceTextBox" CallBack="myForm.sourceTextBox" 
						Mode="popup" 
						RapidSpellWebPage="CustomSpellCheckerPopUp.aspx"
						WindowWidth=530
						WindowHeight=250>
...
<p><font face='arial, helvetica'><a href="index.html">Back to contents page.</a></font>
      ...
      <br><br><p class="copyrightMessage">Copyright &copy; 2002-2003 Keyoti</p><br><br><br></BODY>
</HTML>
